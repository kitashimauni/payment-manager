...
export default function GroupDetailPage() {
  ...
  if (!group) return <div className="page-narrow"><OfflineAwareLink href="/groups" className="back-link">← グループ一覧に戻る</OfflineAwareLink><div className="panel"><div className="empty-state">グループが見つかりません。</div></div></div>;

  return <div className="page-narrow">
    <OfflineAwareLink href="/groups" className="back-link">← グループ一覧に戻る</OfflineAwareLink>
