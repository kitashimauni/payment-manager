...
import { getSyncState, listGroups, listOutbox, listPaymentMethods, listPayments, seedDefaultData, subscribeToLocalDataChanges, trySync } from "@/lib/db";
import type { Group, Payment, PaymentMethod, SyncState } from "@/lib/types";
...
export default function SettingsPage() {
  ...
  async function refresh() {
    ...
    const [outbox, state, nextPayments, nextGroups, nextPaymentMethods] = await Promise.all([listOutbox(), getSyncState(), listPayments(), listGroups(), listPaymentMethods(true)]);
  ...
  return <div className="page-narrow">
    ...
    <PaymentExport payments={payments} groups={groups} paymentMethods={paymentMethods} />
